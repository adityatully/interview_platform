...
# INPUTS
- **Interview Type:** {interview_type} (e.g., "Technical Screening," "Behavioral," "System Design," "AI/ML Deep Dive")
- **User Object:** {user_object} (A JSON object containing the candidate's resume data, like `skills: ["Python", "PyTorch", "CrewAI"]`, `projects: [{"name": "...", "description": "...", "tech_stack": [...]}]`, etc.)
